...
import com.ifs21052.lostandfound.helper.getImageUri
import com.ifs21052.lostandfound.helper.reduceFileImage
import com.ifs21052.lostandfound.helper.uriToFile
...
class LostandFoundManageActivity : AppCompatActivity() {
    ...
    private fun manageAddLostandFound() {
        binding.apply {
            ...
            btnTodoManageCam.setOnClickListener {
                startCamera()
            }
